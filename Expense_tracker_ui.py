...
def viewwindow():
    ...
    Button(gui,text="Exit Window",font=("candara",15,"bold"),activebackground="#fffa66",activeforeground="blue",width=10,command=gui.destroy).pack()
...
def appwindow():
    ...
    def endpage():
        ...
        Label(gui,font=("courier",35),bg="#bfbfbf",text="MADE BY CHIRAG SAXENA").place(x=500,y=450)
    ...
    gui = Tk()
    gui.title("PERSONAL EXPENSE TRACKER ")
    ...
    l3=Label(gui,font=("comic sans ms",17),bg="#0066ff",text="TYPE OF PRODUCT ").place(x=10,y=200)
    exp_date=StringVar()
    e3=Entry(gui,font=("adobe clean",15),textvariable=exp_date)
    e3.place(x=220,y=205,height=27,width=165)
    
    l4=Label(gui,font=("comic sans ms",17),bg="#0066ff",text="Cost of product").place(x=10,y=250)
    exp_cost=StringVar()
    e4=Entry(gui,font=("adobe clean",15),textvariable=exp_cost)
    e4.place(x=220,y=255,height=27,width=165)
    l5=Label(gui,font=("comic sans ms",17),bg="#1ad1ff",text="Select ID to delete").place(x=520,y=170)
    exp_id=StringVar()
...
Label(root,font=("Ink Free",27),bg="#33cccc",fg="#0000ff",text="CHIRAG SAXENA").place(x=700,y=590)
